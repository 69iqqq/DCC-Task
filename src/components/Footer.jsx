...
//   return (
//     <MDBFooter
//       style={{ backgroundColor: "#44475a", maxWidth: "100%", color: "#f8f8f2" }}
...
//                 Genz Templates
//               </h6> */}
//               <p className='mt-3' style={{ color: "#f8f8f2" }}>
...
//               <h6 className='text-uppercase fw-bold mb-4 mt-3'>Useful links</h6>
//               <p>
...
//               </p>
//               <p>
//                 <MDBIcon icon='phone' /> +91 6909982196
//               </p>
//             </MDBCol>
//           </MDBRow>
//         </MDBContainer>
...
//       <div className='text-center p-3' style={{ backgroundColor: "#ebdbb2" }}>
